...
/**
 * This is the agent for simply get all methods that running in program. To get specific class use :
    ...
    new AgentBuilder.Default()
        ...
        .transform(
            (builder, typeDescription, classLoader, module) ->
                builder.method(ElementMatchers.any()).intercept(Advice.to(AllMethod.class)))
