 ...
 * class. From .ignore(ElementMatchers.none()) we can get all running class in floor and we can use
    ...
    new AgentBuilder.Default()
        ...
        .transform(
            (builder, typeDescription, classLoader, module) ->
                builder.method(ElementMatchers.any()).intercept(Advice.to(IgnoreClass.class)))
